    ...
    def __init__(self, **kwargs):
        ...
        _validate(kwargs,
            ...
            CaseType       = Required(Enum('iph4bt', 'iph4tough', 'iph4vibe', 'iph3bt',
                ...
                'iph5bt', 'iph5vibe', 'iph5cbt', 'iph5xtreme', 'iph6bt', 'iph6tough', 'iph655bt', 'iph655tough', 'ipad4bt', 'ipadminitough',
                'ipt5gbt', 'ssgn2tough', 'bbz10tough', 'ssgs4bt', 'ssgs4vibe', 'ssgs5bt', 'ssgn4bt')),
            Quantity       = Required(),
